...
if ($result->num_rows > 0) {
    ...
    $startDate1 = date('j-M-Y', strtotime($maintenance_data['start_date'])); // j = Day without leading zeros, M = Short month name, Y = Full year
    $endDate1 = date('j-M-Y', strtotime($maintenance_data['end_date']));

    // Extract the number of months from payment_duration
